...
const Timeline: React.FC = () => {
  ...
  const events: TimelineEvent[] = [
    { date: '25-29 November 2024', description: 'hearing', backgroundImage: 'url(/abstract/abstract1.svg)', textColor: 'text-blue-400', transform: 'translateX(-20%)' },
    { date: '30 November 2024', description: 'debat', backgroundImage: 'url(/abstract/abstract2.svg)', textColor: 'text-blue-400', transform: 'translateX(10%)' },
  ];
